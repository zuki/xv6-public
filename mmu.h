...
#define FL_IOPL_MASK    0x00003000      // 12-13: I/O特権レベル・ビットマスク
...
// インデックスとオフセットから仮想アドレスを構成
#define PGADDR(d, t, o) ((uint)((d) << PDXSHIFT | (t) << PTXSHIFT | (o)))

// ページディレクトリとページテーブルの定数
#define NPDENTRIES      1024    // PGDIRあたりのディレクトリエントリ数
#define NPTENTRIES      1024    // ページテーブルあたりのPTE数
#define PGSIZE          4096    // 1ページにマッピングされるバイト数

#define PGSHIFT         12      // log2(PGSIZE)
#define PTXSHIFT        12      // リニアアドレスにおけるPTXのオフセット
#define PDXSHIFT        22      // リニアアドレスにおけるPDXのオフセット
